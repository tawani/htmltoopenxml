namespace HtmlToOpenXml.Tests.Primitives
{
    ...
    public class DataUriTests
    {
        ...
        {
            // red dot
            Assert.NotNull("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAHElEQVQI12P4//8/w38GIAXDIBKE0DHxgljNBAAO9TXL0Y4OHwAAAABJRU5ErkJggg==");
        }
...
";
            Assert.NotNull(DataUri.Parse(html));
        }
    }
}